...
Представляем обновлённую версию ShortMappet — расширенный вариант Mappet Reforged для создания приключенческих карт и игровых сценариев.
...
Система Script Proposal была удалена. Также из архива убраны переводы на турецкий, украинский и китайский языки. Если ваши карты или скрипты используют Script Proposal, перед обновлением потребуется адаптация.
...
### ShortMappet for Minecraft 1.20.1

We are releasing an updated version of ShortMappet — an expanded Mappet Reforged build for creating adventure maps and scripted gameplay.
...
The Script Proposal system has been removed. Turkish, Ukrainian, and Chinese localization files were also removed. Maps or scripts that depend on Script Proposal may require changes before upgrading.

ShortMappet still targets Minecraft 1.20.1 and Java 17.
