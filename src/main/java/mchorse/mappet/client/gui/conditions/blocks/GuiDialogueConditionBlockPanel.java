...
public class GuiDialogueConditionBlockPanel extends GuiAbstractConditionBlockPanel<DialogueConditionBlock> {
   ...
   public GuiDialogueConditionBlockPanel(class_310 mc, GuiConditionOverlayPanel overlay, DialogueConditionBlock block) {
      ...
      this.add(Elements.row(mc, 5, new GuiElement[]{Elements.column(mc, 5, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.conditions.dialogue.id")).marginTop(12), this.id}), Elements.column(mc, 5, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.conditions.dialogue.marker")).marginTop(12), this.marker})}));
