...
public class GuiFactionConditionBlockPanel extends GuiAbstractConditionBlockPanel<FactionConditionBlock> {
   ...
   public GuiFactionConditionBlockPanel(class_310 mc, GuiConditionOverlayPanel overlay, FactionConditionBlock block) {
      ...
      this.add(Elements.row(mc, 5, new GuiElement[]{Elements.column(mc, 5, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.conditions.faction.id")).marginTop(12), this.id}), Elements.column(mc, 5, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.conditions.faction.check")).marginTop(12), this.faction})}));
