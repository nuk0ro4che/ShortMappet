...
public class GuiMorphConditionBlockPanel extends GuiAbstractConditionBlockPanel<MorphConditionBlock> {
   ...
   public GuiMorphConditionBlockPanel(class_310 mc, GuiConditionOverlayPanel overlay, MorphConditionBlock block) {
      ...
      this.add(new IGuiElement[]{this.morph, this.onlyName});
