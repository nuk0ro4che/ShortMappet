...
public class GuiQuestConditionBlockPanel extends GuiAbstractConditionBlockPanel<QuestConditionBlock> {
   ...
   public GuiQuestConditionBlockPanel(class_310 mc, GuiConditionOverlayPanel overlay, QuestConditionBlock block) {
      ...
      this.add(Elements.row(mc, 5, new GuiElement[]{Elements.column(mc, 5, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.conditions.quest.id")).marginTop(12), this.id}), Elements.column(mc, 5, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.conditions.quest.check")).marginTop(12), this.quest})}));
