...
public class GuiCraftingRecipeEditor extends GuiElement {
   ...
   public GuiCraftingRecipeEditor(class_310 mc) {
      super(mc);
      ...
      this.input = new GuiItemsElement(mc, IKey.lang("mappet.gui.crafting.input"), (List)null);
      ...
      this.output = new GuiItemsElement(mc, IKey.lang("mappet.gui.crafting.output"), (List)null);
      ...
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.crafting.recipe.title")), this.title});
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.crafting.recipe.description")).marginTop(12), this.description, this.input, this.ignoreNBT, this.output});
      this.add(Elements.row(mc, 5, new GuiElement[]{Elements.column(mc, 4, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.crafting.recipe.visible")), this.checker}), Elements.column(mc, 4, new GuiElement[]{Elements.label(IKey.lang("mappet.gui.crafting.recipe.hotkey")), this.hotkey})}).marginTop(12));
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.crafting.recipe.trigger")).background().marginTop(12).marginBottom(5), this.trigger});
   }
