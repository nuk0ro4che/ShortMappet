...
public class GuiDialogueNodePanel extends GuiEventBaseNodePanel<DialogueNode> {
   ...
   public GuiDialogueNodePanel(class_310 mc) {
      super(mc);
      ...
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.nodes.dialogue.content")).marginTop(12), this.text, this.color});
   }
