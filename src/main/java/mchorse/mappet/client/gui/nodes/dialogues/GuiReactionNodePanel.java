...
public class GuiReactionNodePanel extends GuiDialogueNodePanel {
   ...
   public GuiReactionNodePanel(class_310 mc) {
      super(mc);
      ...
      this.addAfter(this.text, Elements.row(mc, 0, new GuiElement[]{this.color, this.sound}));
      this.add(this.morph);
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.nodes.dialogue.marker")).marginTop(12), Elements.row(mc, 5, new GuiElement[]{this.marker, this.read})});
   }
