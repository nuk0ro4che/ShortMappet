...
public class GuiQuestNodePanel extends GuiNodePanel<QuestNode> {
   ...
   public GuiQuestNodePanel(class_310 mc) {
      super(mc);
      ...
      this.add(this.quest);
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.nodes.dialogue.provider")).marginTop(12), this.giver});
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.nodes.dialogue.receiver")).marginTop(12), this.receiver});
      this.add(new IGuiElement[]{this.autoAccept, this.allowRetake, this.condition});
   }
