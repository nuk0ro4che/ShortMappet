...
public class GuiNpcGeneralPanel extends GuiNpcPanel {
   ...
   public GuiNpcGeneralPanel(class_310 mc) {
      super(mc);
      ...
      this.xp.limit((double)0.0F).integer();
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.npcs.general.faction")), this.faction});
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.npcs.general.morph")).marginTop(12), this.morph});
      this.add(this.drops.marginTop(12));
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.npcs.general.xp")).marginTop(12), this.xp});
      this.add(this.hasNoGravity.marginTop(12));
      this.add(new IGuiElement[]{Elements.label(IKey.lang("mappet.gui.npcs.general.shadow_size")).marginTop(12), this.shadowSize});
   }
   ...
   public void set(NpcState state) {
      ...
      this.xp.setValue((double)(Integer)state.xp.get());
      this.hasNoGravity.toggled((Boolean)state.hasNoGravity.get());
      this.shadowSize.setValue((double)(Float)state.shadowSize.get());
   }
}
