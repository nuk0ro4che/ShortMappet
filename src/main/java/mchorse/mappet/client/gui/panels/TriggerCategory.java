...
public enum TriggerCategory {
    ...
    WORLD("mappet.gui.settings.categories.world"),
    ...
    public boolean matchesMod(String key) {
        switch (this) {
            ...
            case WORLD:
                return key.startsWith("world_");
            default:
                return !key.startsWith("server_") && !key.toLowerCase().contains("player") && !key.startsWith("block_") && !key.startsWith("living_") && !key.startsWith("entity_") && !key.startsWith("projectile_") && !key.startsWith("world_") && !key.startsWith("voicechat_") && !key.equals("mouse_input") && !key.equals("sound_ended");
        }
    }

    public static boolean isBuiltin(String key) {
        return key.equals("block_break") || key.equals("block_place") || key.equals("block_interact") || key.equals("block_click") || key.equals("entity_damaged") || key.equals("entity_attacked") || key.equals("entity_death") || key.equals("entity_landed") || key.equals("entity_spawn") || key.equals("server_load") || key.equals("server_tick") || key.equals("player_tick") || key.equals("player_chat") || key.equals("player_login") || key.equals("player_logout") || key.equals("player_lmb") || key.equals("player_rmb") || key.equals("player_respawn") || key.equals("player_item_pickup") || key.equals("player_item_toss") || key.equals("player_item_interact") || key.equals("player_entity_interact") || key.equals("player_close_container") || key.equals("player_open_container") || key.equals("player_journal") || key.equals("living_knockback") || key.equals("projectile_impact") || key.equals("living_equipment_change") || key.equals("player_entity_leash") || key.equals("mouse_input") || key.equals("player_keyboard") || key.equals("state_changed") || key.equals("sound_ended") || key.equals("client_tick") || key.equals("world_day_tick") || key.equals("world_weather_change");
    }
}