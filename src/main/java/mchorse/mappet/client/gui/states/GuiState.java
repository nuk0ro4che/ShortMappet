...
public class GuiState extends GuiElement {
   ...
   public GuiState(class_310 mc, String key, States states) {
      super(mc);
      this.key = key;
      this.states = states;
   ...
   private void updateValue() {
      ...
      this.removeAll();
      this.add(new IGuiElement[]{this.id, this.convert, this.value, this.remove});
      if (this.hasParent()) {
