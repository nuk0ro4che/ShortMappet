...
public class GuiCommandTriggerBlockPanel extends GuiAbstractTriggerBlockPanel<CommandTriggerBlock> {
   ...
   public GuiCommandTriggerBlockPanel(class_310 mc, GuiTriggerOverlayPanel overlay, CommandTriggerBlock block) {
      super(mc, overlay, block);
      this.command = GuiMappetUtils.fullWindowContext(new GuiTextElement(mc, 10000, (text) -> (this.block).string = text), IKey.lang("mappet.gui.trigger_types.command"));
