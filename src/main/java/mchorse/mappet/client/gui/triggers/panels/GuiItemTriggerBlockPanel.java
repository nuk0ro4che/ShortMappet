...
public class GuiItemTriggerBlockPanel extends GuiAbstractTriggerBlockPanel<ItemTriggerBlock> {
   ...
   public GuiItemTriggerBlockPanel(class_310 mc, GuiTriggerOverlayPanel overlay, ItemTriggerBlock block) {
      super(mc, overlay, block);
      this.target = (new GuiTargetElement(mc, (Target)null)).skipGlobal();
      ...
      this.add(Elements.row(mc, 5, new GuiElement[]{this.slot, this.mode}));
