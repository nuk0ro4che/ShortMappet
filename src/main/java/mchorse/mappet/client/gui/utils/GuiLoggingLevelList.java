...
public class GuiLoggingLevelList extends GuiListElement<Boolean> {
   ...
   public GuiLoggingLevelList(class_310 mc, Consumer<List<Boolean>> callback) {
      super(mc, callback);
   ...
   public void addLevel(LoggerLevel level) {
      ...
      GuiToggleElement toggleElement = new GuiToggleElement(this.mc, IKey.str(level.value.getName()), true, (Consumer)null);
