...
public class GuiLabelOverlayPanel<T> extends GuiOverlayPanel {
   ...
   public GuiLabelOverlayPanel(class_310 mc, IKey title, Set<Label<T>> keys, Consumer<Label<T>> callback) {
      super(mc, title);
      this.callback = callback;
      this.labels = new GuiLabelSearchListElement<T>(mc, (list) -> this.accept((Label)list.get(0)));
      ...
      ScrollArea var10000 = this.labels.list.scroll;
