...
public class GuiOverlayPanel extends GuiElement {
   ...
   public GuiOverlayPanel(class_310 mc, IKey title) {
      super(mc);
      ...
      this.add(new IGuiElement[]{this.title, this.icons, this.content});
   }
   ...
   protected void drawBackground(GuiContext context) {
      ...
      GuiDraw.drawDropShadow(this.area.x, this.area.y, this.area.ex(), this.area.ey(), 10, 1140850688 + color, color);
