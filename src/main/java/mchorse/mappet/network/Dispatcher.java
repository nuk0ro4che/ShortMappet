...
import mchorse.mappet.network.client.scripts.ClientHandlerBlockBreakSpeed;
...
import mchorse.mappet.network.client.scripts.ClientHandlerHudScale;
...
import mchorse.mappet.network.client.scripts.ClientHandlerPlayerAction;
...
import mchorse.mappet.network.client.scripts.ClientHandlerClientScriptFlags;
...
import mchorse.mappet.network.server.scripts.ServerHandlerRequestClientScriptFlags;
      ...
      public void register() {
         ...
         if (client) {
            ...
            this.register(PacketHudPosition.class, ClientHandlerHudPosition.class, Side.CLIENT);
             this.register(PacketHudScale.class, ClientHandlerHudScale.class, Side.CLIENT);
            ...
            this.register(PacketClientScriptFlags.class, ClientHandlerClientScriptFlags.class, Side.CLIENT);
            ...
            this.register(PacketBlockBreakSpeed.class, ClientHandlerBlockBreakSpeed.class, Side.CLIENT);
            ...
            this.register(PacketPlayerAction.class, ClientHandlerPlayerAction.class, Side.CLIENT);
         ...
         this.register(PacketRequestClientScriptFlags.class, ServerHandlerRequestClientScriptFlags.class, Side.SERVER);
