...
public class AutoCompleteConfig {
   ...
   public static final List<String> JS_KEYWORDS = Arrays.asList("var", "let", "const", "function", "return", "if", "else", "for", "while", "do", "break", "continue", "switch", "case", "default", "new", "delete", "typeof", "instanceof", "in", "of", "indexof", "try", "catch", "finally", "throw", "true", "false", "null", "undefined", "this", "import", "Java");
